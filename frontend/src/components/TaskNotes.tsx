              ...
              >
                <div className="flex justify-between items-start gap-2">
                  ...
                  <Button
                    ...
                    className="h-8 w-8 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 transition-opacity shrink-0"
